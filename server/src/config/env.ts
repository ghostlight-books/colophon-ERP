...
const envSchema = z.object({
  ...
  EBAY_DEFAULT_FULFILLMENT_POLICY_ID: z.string().optional(),
  EBAY_DEFAULT_PAYMENT_POLICY_ID: z.string().optional(),
  EBAY_DEFAULT_RETURN_POLICY_ID: z.string().optional(),
  EBAY_HIGH_VALUE_FULFILLMENT_POLICY_ID: z.string().optional(),
  EBAY_HIGH_VALUE_THRESHOLD: z.coerce.number().default(250),
